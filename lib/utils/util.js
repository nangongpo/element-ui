import Vue from 'vue';
import { safeDocument, safeWindow } from 'element-ui/lib/utils/safe-dom.js';
import { isString, isObject } from 'element-ui/lib/utils/types.js';
...
function rafThrottle(fn) {
  ...
  return function () {
    ...
    if (locked) return;
    locked = true;
    safeWindow.requestAnimationFrame(function (_) {
      fn.apply(_this, args);
      locked = false;
    });
  };
