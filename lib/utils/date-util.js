...
var prevDate = function prevDate(date, amount = 1) {
  return new Date(date.getFullYear(), date.getMonth(), date.getDate() - amount);
};
var nextDate = function nextDate(date, amount = 1) {
  return new Date(date.getFullYear(), date.getMonth(), date.getDate() + amount);
};
...
var modifyWithTimeString = (date, time) => {
  if (date == null || !time) {
    return date;
  }
...
var limitTimeRange = function limitTimeRange(date, ranges, format = 'HH:mm:ss') {
...
var prevYear = function prevYear(date, amount = 1) {
  var year = date.getFullYear();
  var month = date.getMonth();
  return changeYearMonthAndClampDate(date, year - amount, month);
};
var nextYear = function nextYear(date, amount = 1) {
  var year = date.getFullYear();
  var month = date.getMonth();
  return changeYearMonthAndClampDate(date, year + amount, month);
};
