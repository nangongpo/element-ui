...
import __vue_component__$6 from './input.js';
import __vue_component__$7 from './button.js';
...
class Color {
  ...
  fromString(value) {
    ...
    if (value.indexOf('hsl') !== -1) {
      var parts = value.replace(/hsla|hsl|\(|\)/gm, '').split(/\s|,/g).filter(val => val !== '').map((val, index) => index > 2 ? parseFloat(val) : parseInt(val, 10));
      if (parts.length === 4) {
      ...
      var _parts = value.replace(/hsva|hsv|\(|\)/gm, '').split(/\s|,/g).filter(val => val !== '').map((val, index) => index > 2 ? parseFloat(val) : parseInt(val, 10));
      if (_parts.length === 4) {
      ...
      var _parts2 = value.replace(/rgba|rgb|\(|\)/gm, '').split(/\s|,/g).filter(val => val !== '').map((val, index) => index > 2 ? parseFloat(val) : parseInt(val, 10));
      if (_parts2.length === 4) {
...
var script$1 = {
  ...
  components: {
    ...
    ElInput: __vue_component__$6,
    ElButton: __vue_component__$7,
