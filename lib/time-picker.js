...
import { isDateObject, getWeekNumber, formatDate, parseDate, getRangeHours, getRangeMinutes, modifyTime, limitTimeRange, isDate, clearMilliseconds, timeWithinRange, modifyDate } from 'element-ui/lib/utils/date-util.js';
...
import RepeatClick from 'element-ui/lib/directives/repeat-click.js';
...
var TimePicker = {
  ...
  watch: {
    isRange: function isRange(_isRange) {
      if (this.picker) {
        ...
        this.panel = _isRange ? __vue_component__ : __vue_component__$1;
        this.mountPicker();
      } else {
        this.type = _isRange ? 'timerange' : 'time';
        this.panel = _isRange ? __vue_component__ : __vue_component__$1;
  ...
  created: function created() {
    ...
    this.panel = this.isRange ? __vue_component__ : __vue_component__$1;
  }
};
